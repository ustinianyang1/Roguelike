...
Q_CONSTINIT static const qt_meta_stringdata_CLASSBulletENDCLASS_t qt_meta_stringdata_CLASSBulletENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 8),  // "enemyhit"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 12)   // "playerdamage"
    },
    "Bullet",
    "enemyhit",
    "",
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enemyhit((*reinterpret_cast< std::add_pointer_t<qreal>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Bullet::*)(qreal );
            if (_t _q_method = &Bullet::enemyhit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Bullet::enemyhit(qreal _t1)
{
